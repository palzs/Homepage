...
window.onload = function defaultsearch()
    ...
    document.querySelector('.baidu-icon').style.filter = "drop-shadow(0 0 1.5px #cccccc)";
    }
...
$(".google-icon").click(function(){
    ...
    document.querySelector('.google-icon').style.filter = "drop-shadow(0 0 1.5px #cccccc)";
...
$(".bing-icon").click(function(){
    ...
    document.querySelector('.google-icon').style.filter = "";
    document.querySelector('.baidu-icon').style.filter = "";
    document.querySelector('.bing-icon').style.filter = "drop-shadow(0 0 1.5px #cccccc)";
    });
// 随机句子
var a = Math.random() + ""
