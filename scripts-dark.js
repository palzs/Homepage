...
window.onload = function defaultsearch()
    ...
    document.querySelector('.baidu-icon').style.filter = "drop-shadow(0 0 1.5px #9D2222) brightness(120%)";
    }
...
$(".google-icon").click(function(){
    ...
    document.querySelector('.google-icon').style.filter = "drop-shadow(0 0 1.5px #9D2222) brightness(120%)";
...
$(".bing-icon").click(function(){
    ...
    document.querySelector('.google-icon').style.filter = "";
    document.querySelector('.baidu-icon').style.filter = "";
    document.querySelector('.bing-icon').style.filter = "drop-shadow(0 0 1.5px #9D2222) brightness(120%)";
    });
// 随机句子
var a = Math.random() + ""
